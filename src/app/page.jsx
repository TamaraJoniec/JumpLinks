...
export default function Home() {
  ...
  return (
    <div>
      <header className=" min-h-[75vh] min-w-[100vw] bg-slate-300 py-10 px-40  bg-auto bg-no-repeat bg-center" alt="leeds lights birds' eye view road" style={{ backgroundImage: `url('https://www.telegraph.co.uk/content/dam/Travel/Destinations/Europe/United%20Kingdom/Yorkshire/Leeds/Leeds-lights-roads-Getty.jpg')`}}>
      </header>
